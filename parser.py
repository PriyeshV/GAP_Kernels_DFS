...
class Parser(object):
    ...
    def __init__(self):
            ...
            parser.add_argument("--project", default='GAP', help="Project folder")
            parser.add_argument("--dataset", default='wiki', help="Dataset to evluate")
            ...
            parser.add_argument("--folder_suffix", default='D1_cora_gat0_att1_lre2_l2e3_din0_dout5_sdin_5_sub1_perc5', help="folder name suffix")
            parser.add_argument("--subset", default=1, help="Percentage of Node drop from neighborhood", type=float)
            ...
            parser.add_argument("--drop_in", default=0, help="Dropout for input", type=float)
            parser.add_argument("--drop_out", default=0.5, help="Dropout for pre-final layer", type=float)
            parser.add_argument("--sparse_drop", default=0.5, help="Sparse Dropout", type=float)
            ...
            #========================= Unused ==============================
            parser.add_argument("--cell", default='myLSTM', help="RNN cell (LSTM, myLSTM, GRU, LSTMgated)")
